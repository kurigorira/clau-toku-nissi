...
CREATE TABLE m_item (
  ...
  KEY idx_item_dept (dept_id, sort_no),
  KEY idx_item_group (group_code, sort_no)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE d_daily_value (
  ...
  KEY idx_daily_item (item_code, hizuke)             -- 月次集計で使う
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE d_tokki (
  tokki_id     BIGINT       NOT NULL AUTO_INCREMENT,
  hizuke       DATE         NOT NULL,
  ...
  PRIMARY KEY (tokki_id),
  KEY idx_tokki_hizuke (hizuke)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
